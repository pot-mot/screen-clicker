...
import type {EditListProps} from './ListProps.ts';
import type {EditListEmits} from './ListEmits.ts';
import {
    createSelectRange,
    useListSelection,
} from './listSelection.ts';
import {judgeTargetIsInteraction} from '@renderer/utils/event/judgeEventTarget.ts';
import {useClickOutside} from './useClickOutside.ts';
import IconAdd from '@renderer/components/icons/IconAdd.vue';
